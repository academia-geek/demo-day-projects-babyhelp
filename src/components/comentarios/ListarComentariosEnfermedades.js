...
export default function ListarComentariosEnfermedades() {
    ...
    const { comentariosEnfermedades } = useSelector(store => store.comentariosEnfermedades);
    console.log(comentariosEnfermedades)
