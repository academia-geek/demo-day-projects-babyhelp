...
import { addcomentariosLactanciaAsync} from '../../redux/actions/actionComentariosLactancia';
import uuid from 'react-uuid';
import '../../styles/Blogs.css'
import ListarComentariosLactancia from './ListarComentariosLactante';
import { listperfilAsyn } from '../../redux/actions/actionPerfil';
import { useEffect } from 'react';

export default function AddComentariosLactancia() {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(addcomentariosLactanciaAsync({
            ...formValue,
            nombre: perfill,
            fecha: output,
            id: uuid()
