    ...
    return (
        <>
            ...
            <div className="container-fluid contelacta">
                ...
                <Accordion defaultActiveKey="0" style={{ width: '80%', margin: '0 auto', marginTop: '5%' }}>
                    ...
                    <Accordion.Item eventKey="1">
                        <Accordion.Header>¿PROBLEMAS PARA LACTAR, TE DUELE, NO TE SALE LECHE?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="2">
                        <Accordion.Header>¿Cuánto TIEMPO duran las TOMAS?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                    ...
                    <Accordion.Item eventKey="3">
                        <Accordion.Header>¿Cuándo debería ALTERNAR los pechos?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="4">
                        <Accordion.Header>¿Frecuencia para hacer ERUCTAR al bebé?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <br></br>
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="5">
                        <Accordion.Header>¿QUÉ ES UN BANCO DE LECHE?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <br></br>
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="6">
                        <Accordion.Header>¿PUEDO LACTAR SI TENGO LOS PEZONES INVERTIDOS?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <br></br>
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="7">
                        <Accordion.Header>TÉCNICAS DE SUPLEMENTACIÓN</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <center>
                                <ReactPlayer
                    ...
                    <Accordion.Item eventKey="8">
                        <Accordion.Header>¿Durante CUÁNTO TIEMPO debería seguir AMAMANTANDO a mi bebé?</Accordion.Header>
                        <Accordion.Body className="bodyAcor">
                            <center>
                                <ReactPlayer
